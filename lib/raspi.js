...
Raspi.prototype.digitalRead = function(pinNum, drCallback) {
  ...
  if (pin == null) {
    ...
    pin.on("digitalRead", function(val) {
      this.respond("digitalRead", drCallback, null, val, pinNum);
    }.bind(this));
 ...
 * @publish
 */
Raspi.prototype.digitalWrite = function(pinNum, value, drCallback) {
  var pin = this.pins[this._translatePin(pinNum)];
  ...
  if ((pin != null)) {
    ...
    pin.on("digitalWrite", function(val) {
      this.respond("digitalWrite", drCallback, null, val, pinNum);
    }.bind(this));
    pin.on("connect", function() {
      pin.digitalWrite(value);
    });
 ...
 * @publish
 */
Raspi.prototype.i2cWrite = function(address, cmd, buff, drCallback) {
  var callback = function() {
    this.respond("i2cWrite", drCallback, null, address, cmd, buff);
  }.bind(this);
 ...
 * @publish
 */
Raspi.prototype.i2cRead = function(address, cmd, length, drCallback) {
  var callback = function() {
    this.respond("i2cRead", drCallback, null, address, cmd, length);
  }.bind(this);
 ...
 * @publish
 */
Raspi.prototype.pwmWrite = function(pinNum, value, callback, type) {
  var pin;
...
Raspi.prototype.servoWrite = function(pinNum, angle, callback) {
  this.pwmWrite(pinNum, angle, callback, "servo");
};
